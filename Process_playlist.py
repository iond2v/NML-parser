...
def main():
    ...
    if os.path.exists("./Set056 Ascension Engine (180 - 185).txt"):
        os.remove("Set056 Ascension Engine (180 - 185).txt")
    if os.path.exists("./Set060 Spiritual Gateway (160 - 165).txt"):
        os.remove("Set060 Spiritual Gateway (160 - 165).txt")
